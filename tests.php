...
it("resolves scalar value", function () use ($context) {
...
it("preserves white space", function () use ($context) {
    $template = "{{alias}}";
    $result = Mark::up($template, $context);
...
it("compacts white space between xml elements", function () use ($context) {
    Mark::$compact = true;
...
it("resolves object dot notation", function () use ($context) {
...
it("resolves nested object notation", function () use ($context) {
    $template = "{{name}}Last name: {{last}}{{/name}}";
    $result = Mark::up($template, $context);
    expect($result)->toEqual("Last name: Doe");
});

it("resolves combo object notation", function () use ($context) {
...
it("resolves array index notation", function () use ($context) {
...
it("resolves template with no context object", function () use ($context) {
    $template = "La la la";
    $result = Mark::up($template);
...
it("resolves nested objects with same name", function () use ($context) {
...
it("resolves nested if statements", function () use ($context) {
...
it("resolves undefined/empty values", function () use ($context) {
...
/*  Tests disabled due to PHP not having an equivalent to undefined.
    $template = "{{if foo}}@@@{{else}}###{{/if}}";
    $result = Mark::up($template, ['foo' => null]);
    expect($result)->toEqual("###");
...
it("resolves single pipe on scalar value", function () use ($context) {
    $template = "gender: {{gender|upcase}}";
    $result = Mark::up($template, $context);
    expect($result)->toEqual("gender: MALE");
...
it("resolves null scalar value", function () use ($context) {
    $template = "race: {{race|blank>N/A}}";
    $result = Mark::up($template, $context);
    expect($result)->toEqual("race: N/A");
});

it("resolves boolean values", function () use ($context) {
...
it("resolves multiple pipes on scalar value", function () use ($context) {
...
it("resolves simple array", function () use ($context) {
...
it("resolves self reference in iteration", function () use ($context) {
    $template = "brothers: {{brothers}}+{{.}}+{{/brothers}}";
    $result = Mark::up($template, $context);
    expect($result)->toEqual("brothers: +Jack++Joe++Jim+");
...
it("resolves object self reference", function () use ($context) {
    class Adam {
...
// Test disabled -- PHP doesn't quite work that way.
...
it("resolves complex array", function () use ($context) {
    $template = "sisters: {{sisters}}<li>{{name}}</li>{{/sisters}}";
    $result = Mark::up($template, $context);
    expect($result)->toEqual("sisters: <li>Jill</li><li>Jen</li>");
});

it("resolves iteration using dot notation", function () use ($context) {
...
it("resolves pipe on complex array", function () use ($context) {
...
/*
Test disabled -- sounds like a mis-feature to me.
it("resolves pipe on object", function () use ($context) {
...
it("resolves if", function () use ($context) {
...
it("resolves if/else", function () use ($context) {
...
it("resolves empty or not empty", function () use ($context) {
...
it("handles undeclared pipe", function () use ($context) {
    $template = "{{gender|foo}}";
    $result = Mark::up($template, $context);
    expect($result)->toEqual("male");
...
it("handles null pointer", function () use ($context) {
    $template = "{{race|chop>50}}";
    $result = Mark::up($template, $context);
    expect($result)->toEqual("null");
});

it("resolves custom pipes", function () use ($context) {
    // passed arg
    $times = function($num, $n) {
        return $num * $n;
    };
...
it("resolves included strings", function () use ($context) {
    // passed arg
    $greeting = "My name is {{name.first|upcase}}!";
...
it("resolves included functions", function () use ($context) {
...
it("resolves globals", function () use ($context) {
...
it("resolves iteration counter", function () use ($context) {
    $template = "{{brothers}}{{#}}-{{.}} {{/brothers}}";
    $result = Mark::up($template, $context);
...
it("resolves custom delimiter", function () use ($context) {
    Mark::$delimiter = ":";
...
it("resolves pipe: blank", function () use ($context) {
...
it("resolves pipe: empty", function () use ($context) {
...
it("resolves pipe: notempty", function () use ($context) {
...
it("resolves pipe: limit", function () use ($context) {
    $template = "{{brothers|limit>1}}{{.}}{{/brothers}}";
    $result = Mark::up($template, $context);
    expect($result)->toEqual("Jack");
...
it("resolves pipe: more", function () use ($context) {
    $template = "{{if brothers|more>3}}***{{/if}}";
    $result = Mark::up($template, $context);
    expect($result)->toEqual("");
});

it("resolves pipe: ormore", function () use ($context) {
...
it("resolves pipe: less", function () use ($context) {
    $template = "{{if brothers|less>3}}{{.}}{{/if}}";
    $result = Mark::up($template, $context);
    expect($result)->toEqual("");
});

it("resolves pipe: orless", function () use ($context) {
    $template = "{{if brothers|orless>3}}***{{/if}}";
    $result = Mark::up($template, $context);
    expect($result)->toEqual("***");
});

it("resolves pipe: between", function () use ($context) {
...
it("resolves pipe: equals", function () use ($context) {
    $template = "{{if age|equals>33.3}}{{age}}{{/if}}";
    $result = Mark::up($template, $context);
    expect($result)->toEqual("33.3");
});

it("resolves pipe: notequals", function () use ($context) {
    $template = "{{if age|notequals>33.3}}{{age}}{{/if}}";
    $result = Mark::up($template, $context);
    expect($result)->toEqual("");
});

it("resolves pipe: like", function () use ($context) {
...
it("resolves pipe: notlike", function () use ($context) {
    $template = "{{if name.first|notlike>Jo*}}{{name.first}}{{/if}}";
    $result = Mark::up($template, $context);
    expect($result)->toEqual("");
});

it("resolves pipe: trim", function () use ($context) {
    $template = "{{alias|trim}}";
    $result = Mark::up($template, $context);
    expect($result)->toEqual("J. Doe");
});

it("resolves pipe: pack", function () use ($context) {
    $template = "{{greet|pack}}";
    $result = Mark::up($template, $context);
    expect($result)->toEqual("Top of the morning");
});

it("resolves pipe: upcase", function () use ($context) {
    $template = "{{name.first|upcase}}";
    $result = Mark::up($template, $context);
    expect($result)->toEqual("JOHN");
});

it("resolves pipe: capcase", function () use ($context) {
    $template = "{{motto|capcase}}";
    $result = Mark::up($template, $context);
    expect($result)->toEqual("Life Is Like A Box Of Chocolates");
});

it("resolves pipe: downcase", function () use ($context) {
    $template = "{{name.first|downcase}}";
    $result = Mark::up($template, $context);
    expect($result)->toEqual("john");
});

it("resolves pipe: chop", function () use ($context) {
...
it("resolves pipe: tease", function () use ($context) {
...
it("resolves pipe: round", function () use ($context) {
    $template = "{{age|round}}";
    $result = Mark::up($template, $context);
    expect($result)->toEqual("33");
});

it("resolves pipe: size/length", function () use ($context) {
...
// Tests disabled -- having a hard time figuring out why #|size should be 2.
...
it("resolves pipe: clean", function () use ($context) {
    $template = "{{link|clean}}";
    $result = Mark::up($template, $context);
    expect($result)->toEqual("example.com");
});

it("resolves pipe: reverse", function () use ($context) {
    $template = "{{brothers|reverse}}";
    $result = Mark::up($template, $context);
    expect($result)->toEqual("JimJoeJack");
});

it("resolves pipe: join", function () use ($context) {
...
it("resolves pipe: sort", function () use ($context) {
...
it("resolves pipe: choose", function () use ($context) {
...
it("resolves pipe: toggle", function () use ($context) {
...
it("resolves pipe: fix", function () use ($context) {
    $template = "{{age|fix>3}}";
    $result = Mark::up($template, $context);
    expect($result)->toEqual("33.300");
});

it("resolves pipe: mod", function () use ($context) {
    $template = "{{weight|mod>50}}";
    $result = Mark::up($template, $context);
    expect($result)->toEqual("45");
});

it("resolves pipe: divisible", function () use ($context) {
...
it("resolves pipe: even", function () use ($context) {
    $template = "{{num|even}}";
...
it("resolves pipe: odd", function () use ($context) {
    $template = "{{num|odd}}";
    $result = Mark::up($template, ['num' => 222]);
    expect($result)->toEqual("false");
...
it("resolves pipe: number", function () use ($context) {
    $template = "{{num|number}}";
...
it("resolves pipe: url", function () use ($context) {
    $template = "{{path|url}}";
    $result = Mark::up($template, $context);
    expect($result)->toEqual("example.com?a=b%20c=d");
});

it("resolves pipe: bool", function () use ($context) {
...
it("resolves pipe: first", function () use ($context) {
...
it("resolves pipe: last", function () use ($context) {
...
it("resolves pipe: falsy", function () use ($context) {
...
it("resolves pipe: call", function () use ($context) {
    class Doggy {
        const TYPE_MUTT = 'Mutt';

        public function greet() {
            return 'Woof!';
        }

        public function getBreed($name = null) {
            return !!$name ? Doggy::TYPE_MUTT : 'N/A';
        }
    }
    ...
    $template = "{{doggy|call>getBreed>Milo|downcase}}";
    $result = Mark::up($template, ['doggy' => new Doggy]);
    expect($result)->toEqual("mutt");

// Disabling a couple of tests since PHP can't call methods on primitives.
...
//    expect($result)->toEqual("ad*am*ma*rk");
    ...
    $template = "{{a|call>getTimestamp}}";
    $result = Mark::up($template, ['a' => new DateTime('2011-01-01 00:00:00')]);
    expect($result)->toEqual('1293793200');
});

it("resolves pipe: set", function () use ($context) {
...
it("resolves backtick expressions", function () use ($context) {
...
/*
Test disabled, not implementing the whole extras lib just yet.
it("resolves pipe: pluralize", function () use ($context) {
    Mark::$includes = [
